...
{
  "$end", "error", "$undefined", "S_ALWAYS", "S_ASSIGN", "S_ASSIGN_MEM",
  "S_ASSIGN_MUX", "S_ELSE", "S_EVENT", "S_EXPR", "S_IF", "S_INITIAL",
...
{
       8,     1,     3,     4,     5,     6,     9,     7,    11,    10,
      12,     0,     0,     0,     0,    13,    14
};

static const yytype_int8 yycheck[] =
{
       4,     3,    12,     0,    13,     8,    10,    14,     9,    15,
       4,    -1,    -1,    -1,    -1,    15,    15
};
...
yyreduce:
  ...
  case 2:
#line 85 "syn-rules.y"
                { make_DFF_CE(des_, yyvsp[-6]->top, yyvsp[-3]->event, 0, yyvsp[-1]->assign);
		}
#line 1365 "syn-rules.cc"
    break;

  case 3:
#line 89 "syn-rules.y"
                { make_DFF_CE(des_, yyvsp[-9]->top, yyvsp[-6]->event, yyvsp[-3]->expr, yyvsp[-2]->assign);
		}
#line 1372 "syn-rules.cc"
    break;


#line 1376 "syn-rules.cc"
